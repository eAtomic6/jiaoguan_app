    ...
    <div class="data-layout">
      ...
      <div class="data-list" v-loading="loading">
        <el-table :data="receivableList" style="width: 100%" @row-dblclick="dialogVisible = true"  ref="tableCom" :max-height="tableNumberCom" border>
          ...
          <el-table-column label="签约方式" align="center" min-width="60">
          </el-table-column>
          ...
          <el-table-column prop="agentReceipts" label="实收金额（元）" align="center" min-width="80"></el-table-column>

          <el-table-column label="分账金额（元）" align="center" min-width="80"></el-table-column>
        </el-table>
         <el-pagination
